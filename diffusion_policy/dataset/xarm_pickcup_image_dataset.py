...
class XarmPickcupImageDataset(BaseImageDataset):
    def __init__(self,
            shape_meta: dict,
            dataset_path: str,
            horizon=1,
        ...
        # print(list(replay_buffer.data.keys()))
        # output is: ['action', 'camera_1', 'camera_3', 'robot_eef_pose']
...
def _get_replay_buffer(dataset_path, shape_meta, store):
    ...
    with threadpool_limits(1):
        # print(dataset_path)
        # print(out_resolutions)
        # print(lowdim_keys)
        # print(rgb_keys)
        """
        dataset_path: data/xarm_real/xarm_pickcup_20250224
        out_resolutions: {'camera_1': (320, 240), 'camera_3': (320, 240)}
        lowdim_shapes: ['robot_eef_pose', 'robot_eef_quat', 'robot_gripper_qpos']
        rgb_keys: ['camera_1', 'camera_3']
        """
